...
#                     print(f"Task {task.id} (RAM: {task.ram}, ROM: {task.rom}, Priority: {task.priority}) "
#                           f"offloaded to Server {server.id} (Available RAM: {server.available_ram}, "
#                           f"Available ROM: {server.available_rom})")
#                 else:
...
#                         reward = 1  # Reward for successful offloading
#                         print(f"Task {task.id} (RAM: {task.ram}, ROM: {task.rom}, Priority: {task.priority}) "
#                               f"offloaded to nearest Server {nearest_server.id} (Available RAM: {nearest_server.available_ram}, "
#                               f"Available ROM: {nearest_server.available_rom})")
#                     else:
#                         reward = -1  # Penalty for unsuccessful offloading
#                         print(f"Task {task.id} (RAM: {task.ram}, ROM: {task.rom}, Priority: {task.priority}) "
#                               f"could not be offloaded to any server - Insufficient resources")
